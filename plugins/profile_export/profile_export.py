...
class ProfileExport:
    ...
    def __init__(self, iface):
        ...
        self.actions = []
        self.menu = self.tr(u'&Profile Export')
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('ProfileExport', message)
    ...
    def initGui(self):
        ...
        icon_path = ':/plugins/profile_export/icon.png'
        self.add_action(
            icon_path,
            text=self.tr(u'Profile to text file'),
            callback=self.run,
